    ...
    <div v-else-if="config" class="p-6">
      <div v-if="config.enabled" data-test="affinity-details" class="space-y-6">
        ...
        <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          ...
          <NumberField v-model="config.conversation_identity_ttl_seconds" :label="t('admin.settings.openAIUserAffinity.conversationIdentityTTL')" :hint="t('admin.settings.openAIUserAffinity.conversationIdentityTTLHint')" :min="86400" :max="2592000" />
