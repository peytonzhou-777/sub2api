export default {
  ...
  payment: {
    ...
    result: {
      ...
      securityDepositSuccess: 'Security Deposit Paid',
    ...
    account: {
      ...
      depletedCreditDetails: 'Depleted Limited Credits',
      depletedCreditHint: 'Filter by depletion time, up to 366 days per query',
      noDepletedCredits: 'No depleted limited credits in the selected time range',
      depleted: 'Depleted',
      depletedAt: 'Depleted at {time}',
      historyRangeInvalid: 'Select a valid time range of no more than 366 days',
      historyLoadFailed: 'Failed to load depleted limited credits. Please try again later.',
      ...
      securityDepositBonusCreditReason: 'Security deposit bonus',
      usage: 'Credit Usage',
      daysRemaining: '{days} days remaining',
      ...
      fullRefund: 'Balance Refund'
    },
    securityDeposit: {
      title: 'Security Deposit',
      separateBalanceHint: 'This deposit is separate from API credit and is never consumed by normal usage.',
      loadFailed: 'Security deposit details could not be loaded. Try again later.',
      totalBalance: 'Total Deposit',
      paidBalance: 'User-paid Balance',
      adminGrantBalance: 'Admin-granted Balance',
      refundable: 'Refundable Now',
      refundPending: 'Refund Pending',
      timedLocked: 'Time-locked {amount}',
      permanentLocked: 'Permanently locked {amount}',
      nextUnlockAt: 'Next unlock {time}',
      ...
      bonusTitle: 'Security Deposit Bonus',
      bonusDescription: 'After reaching an available group threshold, the daily bonus accumulates into one 7-day limited credit and refreshes its expiry. The cap uses the CNY deposit face value.',
      bonusCurrent: 'Current bonus',
      bonusDaily: 'Daily setting',
      bonusCap: 'Current cap ({ratio}%)',
      bonusEstimated: 'Next estimated addition',
      bonusExpiresAt: 'Current bonus expires at {time}',
      bonusEligible: 'The “{group}” threshold is met. An estimated {amount} will be added at {time}.',
      bonusReasons: {
        enforcement_disabled: 'Deposit enforcement is disabled, so no bonus is currently issued.',
        daily_amount_disabled: 'No daily deposit bonus is currently configured.',
        threshold_not_met: 'The effective deposit does not currently meet any non-zero available group threshold.',
        cap_reached: 'The bonus has reached its current effective-deposit cap. Its 7-day expiry will still refresh at the next eligible issuance.'
      },
      ...
      adminGrantLot: 'Admin-granted deposit',
      originalAmount: 'Original amount {amount}',
      permanentlyLocked: 'Permanently locked',
      refundableNow: 'Refundable',
      contactAdmin: 'Contact an administrator for a refund',
      lockedUntil: 'Locked until {time}',
      notRefundable: 'Not currently refundable',
      refundAction: 'Request refund',
      refundTitle: 'Confirm Deposit Refund',
      refundPrincipal: 'Deposit principal',
      gatewayRefundAmount: 'Estimated original-channel refund',
      affectedKeys: '{count} API key(s) will be disabled after the refund',
      requiredAfterRefund: 'Threshold {amount}',
      refundConfirmationHint: 'New model requests will be blocked while in-flight requests drain. The entire remaining deposit lot will then be returned through its original payment channel. Keys disabled by this refund are not automatically re-enabled if the refund fails.',
      confirmRefund: 'Confirm original-channel refund',
      refundSucceeded: 'The security deposit refund is complete.',
      refundPendingReview: 'The refund was submitted and is awaiting provider confirmation. It will not be submitted again.',
      refundFailed: 'The security deposit refund could not be processed. Refresh and try again.'
    },
	refunds: {
	  title: 'Balance Refund',
	  backToAccount: 'Back to Account',
	  permanentBalance: 'Remaining Permanent Credit',
	  rechargeBonus: 'Remaining Recharge Bonus',
	  otherCreditToClear: 'Other Credit to Clear',
	  gatewayTotals: 'Refund to Original Payment Methods',
	  orders: 'Recharge Orders and Refund Routes',
	  orderCount: '{count} orders',
	  order: 'Order', paid: 'Original Payment', bonus: 'Remaining Bonus', eligibleCredit: 'Eligible Credit', actualRefund: 'Actual Refund',
	  manualReview: 'Manual Review Required',
	  estimateReady: 'The account total is reconciled and ready for a balance refund.',
	  estimateBlocked: 'The account data cannot be reconciled automatically.',
	  lockAcknowledgement: 'I understand that API access stops immediately. In-flight requests will still settle, and the final quote is calculated after they drain.',
	  finalAcknowledgement: 'I reviewed the final quote and confirm clearing all refundable recharge benefits and other limited credits, with each amount returned to its original payment method.',
	  start: 'Start Refund', confirm: 'Confirm Balance Refund', continue: 'Continue Processing', cancelAndUnlock: 'Cancel and Unlock Account',
	  reconciling: 'Reconciling gateway refund status', recoveryHelp: 'The refund is not finished. Confirmed failures can continue; unknown gateway outcomes require customer support review and are never retried automatically.',
	  draining: 'Stopping API access and finalizing billing', canceled: 'Refund canceled and account status restored',
	  restoreTitle: 'Restore Refund Session',
	  restoreDescription: 'API access remains stopped. Verify your identity to continue the same balance refund without restoring normal sign-in access.',
    ...
    rechargeActivities: {
      ...
      startAt: 'Start Time',
      endAt: 'End Time',
      participationLimit: 'Uses Per User',
      tiers: 'Bonus Tiers',
      addTier: 'Add Tier',
      minAmount: 'Minimum Credit',
      maxAmount: 'Maximum Credit',
      minRate: 'Minimum Bonus Rate (%)',
      maxRate: 'Maximum Bonus Rate (%)',
      tierCount: '{count} tiers',
      unlimited: 'Unlimited uses',
      limitCount: 'Up to {count} uses per user',
      endEarly: 'End Early',
      deleteConfirm: 'Delete this scheduled activity?',
      endConfirm: 'End this activity now? Existing orders will retain their bonus snapshot.',
      ended: 'Activity ended',
      invalidForm: 'Check the activity dates, participation limit, and tier ranges.',
      loadFailed: 'Failed to load recharge activities',
      saveFailed: 'Failed to save recharge activity',
      deleteFailed: 'Failed to delete recharge activity',
      status: {
        scheduled: 'Scheduled',
        active: 'Active',
        ended: 'Ended',
    ...
    errors: {
      ...
      REFUND_FAILED: 'Refund failed.',
	  REFUND_MANUAL_REVIEW: 'The account balance requires manual review.',
	  REFUND_QUOTE_CHANGED: 'The refund amount changed. Review the quote again.',
	  REFUND_ALREADY_ACTIVE: 'An account refund is already in progress.',
	  REFUND_NOT_READY_TO_CONFIRM: 'In-flight billing has not fully settled.',
