export default {
  ...
  payment: {
	...
	refunds: {
	  ...
	  start: 'Start Refund', confirm: 'Confirm Balance Refund', draining: 'Stopping API access and finalizing billing', canceled: 'Refund canceled and account status restored',
