export default {
  ...
  keys: {
    ...
    securityDeposit: {
      ...
      currentBalance: 'Current Deposit',
      baseRequired: 'Base Threshold',
      riskMultiplierLabel: 'Current Risk Multiplier',
      personalThreshold: 'Personal Threshold',
      ...
      quoteChanged: 'The deposit quote or rules changed. The latest quote has been loaded.',
      paymentUnavailable: 'This payment method cannot complete the deposit. Choose another method.',
      wechatUnavailable: 'WeChat payment is unavailable in this environment. Reopen the page or choose another method.',
      loadFailed: 'Security deposit information could not be loaded. Try again later.'
    },
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    ...
    status: {
      active: 'Active',
      inactive: 'Inactive',
	  disabled: 'Disabled for insufficient deposit',
      quota_exhausted: 'Quota Exhausted',
      expired: 'Expired',
	  security_locked: 'Security policy locked',
    },
  },
  ...
  accountPool: {
    ...
    querySevenDayUsage: 'Query 7-day contacted usage',
    sortAscending: 'Sort ascending',
    sortDescending: 'Sort descending',
    columns: { id: 'Account ID', platformType: 'Account Type', relation: 'My Relationship', capacity: 'Account Capacity', usageWindow: 'Account Usage', personalUsage: 'Personal Usage', resetCount: 'Account Reset Count', status: 'Account Status' },
    relations: { all: 'All relationships', currentResidence: 'Current residence', sevenDayContact: 'Contacted in 7 days', historicalContact: 'Historically contacted' },
