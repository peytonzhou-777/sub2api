export default {
  ...
  accountPool: {
    ...
    relations: { all: 'All relationships', currentResidence: 'Current residence', primaryResidence: 'Primary residence', sevenDayContact: 'Contacted in 7 days', historicalContact: 'Historically contacted' },
