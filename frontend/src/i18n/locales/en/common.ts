export default {
  common: {
    ...
    earliestExpiringLimitedBalance: 'Earliest expiring limited balance',
    expiresOn: 'Expires on {date}',
    viewLimitedBalanceDetails: 'View limited balance details',
    ...
    customerServiceGroupNumber: 'Group: {number}',
    customerServiceGroupAction: 'Copy group number {number} and open the support group',
    customerServiceGroupCopied: 'Support group number copied',
    add: 'Add',
  ...
  nav: {
    ...
    workbenchWallet: 'Wallet',
    collapse: 'Collapse',
    expand: 'Expand',
    logout: 'Logout',
    github: 'GitHub',
    mySubscriptions: 'My Subscriptions',
    buySubscription: 'My Account',
    docs: 'Docs',
    myOrders: 'My Orders',
  ...
  auth: {
    ...
    promoCodeLimitedCreditValid: 'Valid! You will receive ${amount} limited credit for {days} days',
    ...
    legacyEligibilityCheck: 'Check legacy-user eligibility',
    legacyEligibilityChecking: 'Checking eligibility...',
    legacyEligibilityEligible: 'This email is eligible to register without an invitation code',
    legacyEligibilityNotEligible: 'This email is not eligible to register without an invitation code',
    legacyEligibilityRequired: 'Check and pass legacy-user eligibility, or enter a valid invitation code',
    legacyReasonNotLegacyUser: 'Not a user of the original site',
    legacyReasonInsufficientSuccessCalls: 'Insufficient successful calls',
    legacyReasonInsufficientActiveDays: 'Insufficient active days',
    legacyReasonCyberPolicyWarning: 'Previously triggered a network security policy alert',
    legacyReasonSoftDeleted: 'Original-site account was deleted',
    legacyReasonExemptionDisabled: 'Legacy-user invitation exemption is disabled',
    registrationCapacityReached: 'No open registration slots remain. Use a valid invitation code to register',
