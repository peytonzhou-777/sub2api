    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          creditType: 'Rebate credit type',
          creditTypePermanent: 'Permanent credit',
          creditTypeLimited: 'Limited credit',
          creditTypeHint: 'Controls which credit wallet receives an available rebate transfer.',
          creditValidityDays: 'Credit validity (days)',
          creditValidityDaysHint: 'The validity period starts when the rebate transfer succeeds.',
      ...
      registration: {
        ...
        expectedCapacity: 'Expected user capacity',
        remainingCapacity: 'Open slots remaining',
        unlimited: 'Unlimited',
        capacityHint: 'Ordinary and legacy-exempt registration closes at this total user count; 0 means unlimited. Valid invitation codes always bypass this limit.',
        capacityInvalid: 'Expected user capacity must be an integer greater than or equal to 0',
        additionalSlots: 'Open additional slots',
        applyAdditionalSlots: 'Apply to expected capacity',
        additionalSlotsInvalid: 'Additional slots must be an integer greater than 0',
        ...
        invitationCodeHint: 'When enabled, users need a valid invitation code or an enabled legacy-user exemption',
        legacyExemption: 'Eligible legacy users register without an invitation',
        legacyExemptionHint: 'Allow eligible emails from the operations list to register without an invitation; this path still observes the user capacity limit',
        legacyImportStats: '{historical} historical emails imported; {eligible} are eligible',
      ...
      defaults: {
        ...
        defaultLimitedCredits: 'Default Limited Credits',
        defaultLimitedCreditsHint: 'Grant these independent, expiring credit batches when a user is created or registers',
        addDefaultLimitedCredit: 'Add Default Limited Credit',
        defaultLimitedCreditsEmpty: 'No default limited credits configured.',
        defaultLimitedCreditsInvalid: 'Each amount must be greater than 0 and validity must be between 1 and 36500 days.',
        limitedCreditAmount: 'Credit Amount',
        limitedCreditValidityDays: 'Validity (days)',
      ...
      gatewayForwarding: {
        ...
        codexEpochRotationTitle: 'Codex Session epoch rotation',
        codexEpochRotationHint: 'Applies globally to session/full convergence modes. Saving affects only subsequent new root conversations; it does not increment existing epochs, disconnect old WebSockets, or clear connection pools.',
        codexEpochRestoreDefaults: 'Restore recommended defaults',
        codexEpochMinAge: 'Minimum lifetime (hours)',
        codexEpochMinAgeHint: 'Range: 1–8760. The idle gate must also be satisfied after this age. Default: 72.',
        codexEpochMaxAge: 'Maximum lifetime (hours)',
        codexEpochMaxAgeHint: 'Range: minimum lifetime–8760. New roots no longer wait for idle after this age. Default: 168.',
        codexEpochJitter: 'Rotation jitter (hours)',
        codexEpochJitterHint: 'Range: 0–8760. Deterministic per account and Session slot; 0 disables jitter. Default: 24.',
        codexEpochIdleGate: 'Rotation idle gate (minutes)',
        codexEpochIdleGateHint: 'Range: 1–10080. Tracked per Session slot, with HTTP and WebSocket sharing activity. Default: 120.',
        codexEpochOldGrace: 'Old epoch grace (hours)',
        codexEpochOldGraceHint: 'Range: 1–8760. Controls old Thread/parent-child binding retention only, not rotation timing. Default: 48.',
        codexEpochEffectiveRange: 'Current idle-rotation base range: {min}–{minWithJitter} hours; forced-rotation base range: {max}–{maxWithJitter} hours. The actual deterministic value is stable per account and slot.',
        codexEpochRangeError: 'Codex epoch values must be integers: lifetime, jitter, and grace cannot exceed 8760 hours; idle gate must be 1–10080 minutes.',
        codexEpochMaxBeforeMinError: 'Codex epoch maximum lifetime cannot be lower than the minimum lifetime.',
      ...
      site: {
        ...
        siteWordmarkSuffix: 'Brand Suffix',
        siteWordmarkSuffixPlaceholder: 'API',
        siteWordmarkSuffixHint: 'Displayed after the site name, such as API or Pro',
        ...
        customerServiceGroupNumber: 'Support Group Number',
        customerServiceGroupNumberPlaceholder: 'e.g., 123456789',
        customerServiceGroupNumberHint: 'When both fields are configured, signed-in users can copy the number and open the support group from the page header.',
        customerServiceGroupLink: 'Support Group Link',
        customerServiceGroupLinkPlaceholder: 'https://qm.qq.com/q/example',
        customerServiceGroupLinkHint: 'Only absolute HTTP(S) links are supported. The header entry stays hidden when either field is empty.',
        customerServiceGroupLinkInvalid: 'The support group link must be an absolute HTTP(S) URL',
      ...
      payment: {
        ...
        securityDepositBonusDailyAmount: 'Daily deposit bonus (USD)',
        securityDepositBonusDailyAmountHint: 'Accumulates at 00:00 Asia/Shanghai for eligible users. Set to 0 to disable bonuses.',
        securityDepositBonusCapRatio: 'Bonus cap ratio (%)',
        securityDepositBonusCapRatioHint: 'Multiplies the CNY face value of the effective deposit by this ratio to produce the same numeric USD cap, without FX conversion. Default is 100%; lowering it does not immediately reduce an existing bonus.',
        ...
        securityDepositPenaltyModeHint: 'Shadow mode records expected penalties only. Enforcement also requires deposit threshold enforcement to be enabled.',
        securityDepositPenaltyOff: 'Off',
        securityDepositPenaltyShadow: 'Shadow record',
        securityDepositPenaltyEnforce: 'Enforce penalties',
        securityDepositFreezeHours: 'Paid deposit freeze (hours)',
        securityDepositMaxRiskMultiplier: 'Maximum risk multiplier',
        securityDepositPolicyVersion: 'Policy version',
        securityDepositAgreementZh: 'Chinese terms (Markdown)',
        securityDepositAgreementEn: 'English terms (Markdown)',
      ...
      authSourceDefaults: {
        ...
        description: 'Configure per-source default balance, concurrency, subscriptions, limited credits, and grant rules.',
        ...
        defaultLimitedCreditsLabel: 'Default limited credits',
        defaultLimitedCreditsHint: 'Applies only to this auth source. Each grant starts its own validity period when issued.',
        noSourceLimitedCredits: 'No source-specific default limited credits configured.',
