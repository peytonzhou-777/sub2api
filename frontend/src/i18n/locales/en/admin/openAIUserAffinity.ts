...
export const openAIUserAffinitySettings = {
  ...
  conversationActiveTTLHint: 'Sliding lifetime of conversation bindings and aliases, also used for Persona user occupancy. Valid activity renews it; in-flight requests are protected. Expired continuations require a new conversation.',
