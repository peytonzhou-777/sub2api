...
export const openAIUserAffinitySettings = {
  ...
  residentTTL: 'Resident preference TTL (seconds)',
  residentTTLHint: 'Successful requests refresh the resident selection preference for new conversations. This does not extend existing conversation bindings.',
  conversationActiveTTL: 'Active conversation occupancy (seconds)',
  conversationActiveTTLHint: 'Occupancy window for Persona users and active routes. In-flight requests are protected. Idle conversations release capacity and reacquire the original Persona on resume without losing their identity.',
  conversationIdentityTTL: 'Conversation identity retention (seconds)',
  conversationIdentityTTLHint: 'Independent sliding retention for bindings and aliases, defaulting to 7 days. Resume keeps the original account, Persona and epoch; revocation and epoch grace expiry remain final.',
