export default {
    ...
    users: {
      ...
      securityDeposit: {
        menuItem: 'Security Deposit',
        title: 'User Security Deposit',
        total: 'Total deposit',
        paid: 'User paid',
        adminGrant: 'Admin granted',
        risk: 'Risk profile',
        riskValue: '{multiplier}x · {strikes} penalties',
        grant: 'Permanent grant',
        compensation: 'Compensation',
        deduct: 'Admin deduction',
        amount: 'Amount (CNY)',
        reasonOptional: 'Reason or note (optional)',
        reasonPlaceholder: 'Leaving this blank does not block the operation',
        submit: 'Confirm operation',
        deductHint: 'Admin deductions use only admin-granted deposits. The whole operation fails when that bucket is insufficient and never touches user-paid deposits.',
        lots: 'Deposit lots',
        paidLot: 'User-paid lot',
        adminGrantLot: 'Permanently locked lot',
        lotBalance: '{remaining} remaining / {original} original',
        revoke: 'Revoke mistaken grant',
        revokeConfirm: 'Revoke the remaining {amount} from this lot? Previously forfeited or deducted amounts are not restored.',
        originalRefund: 'Original-channel refund',
        manualReserve: 'Reserve manual refund',
        refundReserved: '{amount} reserved',
        originalRefundConfirm: 'Refund the remaining {amount} through the original provider? The reservation immediately affects API key eligibility.',
        manualReserveConfirm: 'Reserve the remaining {amount}? Complete the refund externally, then submit the evidence here.',
        noLots: 'No deposit lots',
        refunds: 'Refund records',
        manualRefund: 'Manual external refund',
        fillEvidence: 'Submit evidence',
        queryRefund: 'Query provider',
        refundQuerySucceeded: 'Refund status updated',
        refundQueryFailed: 'The refund result is still unavailable. Try again later or verify it manually.',
        confirmGatewayFailed: 'Confirm no provider refund',
        refundReviewReleased: 'The refund reservation was released using the review evidence.',
        externalRefundId: 'External refund ID',
        externalRefundedAt: 'External refund time',
        externalEvidence: 'Refund evidence',
        externalEvidencePlaceholder: 'Voucher ID, file URL, or finance record reference',
        confirmExternalRefund: 'Confirm external refund',
        noRefunds: 'No refund records',
        refundOperationSucceeded: 'Security deposit refund operation completed',
        refundOperationFailed: 'Security deposit refund operation failed',
        refundStates: {
          reserved: 'Reserved',
          ...
          succeeded: 'Refunded',
          failed_released: 'Failed and released',
          canceled: 'Canceled'
        },
        ledger: 'Recent ledger',
        loadFailed: 'Failed to load security deposit details',
        operationSucceeded: 'Security deposit operation completed',
        operationFailed: 'Security deposit operation failed',
        unlockKey: 'Remove security lock',
        unlockReasonPlaceholder: 'Optional review conclusion or appeal ID',
        unlockHint: 'The key remains disabled after unlocking and is not reactivated automatically.',
        unlockSucceeded: 'Security lock removed; the key remains disabled',
        unlockFailed: 'Failed to unlock the API key'
      },
      // User Attributes
      attributes: {
    ...
    groups: {
      ...
      form: {
        ...
        securityDepositRequired: 'Security deposit threshold (CNY)',
        securityDepositRequiredHint: '0 means no deposit is required. Both time-locked and permanently locked deposits count toward access.',
