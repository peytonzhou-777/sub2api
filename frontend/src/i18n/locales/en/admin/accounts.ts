...
export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Keep one stable account device and converge Sessions by client/semantic protocol and slot. HTTP and WebSocket share rotation state. New roots enter a new epoch after minimum age plus 2 hours idle, or unconditionally at maximum age; old conversations drain naturally.',
        codexSessionSlotCount: 'Session slot count',
        codexSessionSlotCountDesc: 'Range 1–4; 2 is recommended. A root conversation maps stably to one slot, shared by its parent and subagents.',
