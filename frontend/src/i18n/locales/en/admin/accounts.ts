...
export default {
    accounts: {
      ...
      columns: {
        ...
        status: 'Status',
        intelligenceTest: 'Degradation Check',
        routeDetection: 'Actual Route',
        schedulable: 'Schedulable',
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Production defaults to Device + Session: keep one stable account device and converge Sessions by client/semantic protocol and slot. HTTP and WebSocket share rotation state. New roots enter a new epoch after minimum age plus 2 hours idle, or unconditionally at maximum age; existing Threads keep their old binding and drain naturally. Off is rollback-only; other modes are compatibility-only.',
        codexSessionSlotCount: 'Session slot count',
        codexSessionSlotCountDesc: 'Range 1–4; production maintenance recommends 1 to minimize shared visible features. Increase it explicitly for more concurrency, at the cost of more upstream-visible Sessions. A root conversation maps stably to one slot, shared by its parent and subagents.',
        codexSubagentConcurrency: 'Subagent concurrency gate',
        codexSubagentConcurrencyDesc: 'Limits active subagents within one converged Session and queues at capacity. Set 0 to disable; applies only to session and full modes.',
        codexFingerprintOff: 'Off (rollback only)',
        ...
        dynamicPersona: {
          title: 'Outbound Personas',
          summary: '{count} Personas, theoretical concurrency {capacity}',
          add: 'Add Persona',
          profile: 'Outbound profile',
          proxy: 'Outbound proxy',
          inheritProxy: 'Inherit account proxy',
          maxClients: 'Active client Session limit',
          inheritPolicy: 'Inherit Persona policy',
          primary: 'Default Codex / primary account authorization',
          clients: 'Client occupancy',
          ...
          forceRotate: 'Force rotate',
          revoke: 'Revoke authorization',
          hardDisable: 'Hard disable',
          retire: 'Retire record',
          oauthTitle: 'Authorize outbound Persona (position {position})',
          migrationRequired: 'This account has no dynamic Persona and must be migrated during the maintenance window.',
          revokeConfirm: 'Revoke every local authorization chain for this Persona? Other Personas are not affected.',
          hardDisableConfirm: 'Hard disable this Persona immediately? This operation is intended for security incidents.',
          retireConfirm: 'Retire this Persona record permanently? Historical audit data remains in the database.',
          forceRotateConfirm: 'Forced rotation revokes current occupancy. Continue?'
        },
      ...
      routeDetection: 'Actual Route Check',
      routeDetectionTitle: 'OpenAI OAuth Actual Route Check',
      routeDetectionRunning: 'Checking...',
      routeDetectionRunAgain: 'Check again',
      routeDetectionStatusSol: 'Sol',
      routeDetectionStatusLuna: 'Luna',
      routeDetectionStatusInconclusive: 'Inconclusive',
      routeDetectionStatusError: 'Check error',
      routeDetectionStatusNotChecked: 'Not checked',
      routeDetectionRequestedModel: 'Requested model',
      routeDetectionReportedModel: 'Reported model',
      routeDetectionCheckedAt: 'Checked at',
      routeDetectionCredentialAccount: 'Credential account ID',
      routeDetectionReasonCode: 'Reason code',
      routeDetectionResponseHeaders: 'Supporting response headers',
      routeDetectionNotReturned: 'Not returned',
      routeDetectionRequestFailed: 'Route check failed. Try again.',
      intelligenceTest: 'Degradation Check',
      intelligenceTestTitle: 'OpenAI OAuth Degradation Check',
      readyToIntelligenceTest: 'Ready. Click "Start Check" to send the fixed prompt...',
      startIntelligenceTest: 'Start Check',
      intelligenceTesting: 'Running degradation check...',
      intelligenceTestCompleted: 'Degradation check completed!',
      startingIntelligenceTestForAccount: 'Starting degradation check for account: {name}',
      sendingIntelligenceTest: 'Sending the fixed degradation-check prompt...',
      intelligenceTestMode: 'Mode: Fixed-prompt check',
      intelligencePersonaSlotLabel: 'Outbound identity',
      intelligencePersonaSlotStrict: 'Slot 0 · Codex CLI Strict',
      intelligencePersonaSlotOpenCode: 'Slot 1 · OpenCode',
      intelligencePersonaSlotUnavailable: '{slot} (unavailable: {state})',
      intelligencePersonaStatusLoadFailed: 'Unable to load Persona v3 slot status. Try again later.',
      intelligenceTestStatusLabel: 'Check marker',
      intelligenceTestStatusUnmarked: 'Unmarked',
      intelligenceTestStatusPassed: 'Passed',
      intelligenceTestStatusFailed: 'Failed',
      intelligenceTestMarkPassed: 'Mark passed',
      intelligenceTestMarkFailed: 'Mark failed',
      intelligenceTestStatusSaveFailed: 'Unable to save the degradation-check marker. Try again.',
