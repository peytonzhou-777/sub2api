export default {
  ...
  accountPool: {
    title: '号池',
    search: '搜索账号 ID',
    searchPlaceholder: '输入账号 ID（仅数字）',
    invalidId: '账号 ID 必须是大于 0 的数字',
    deletedOrMissing: '账号已删除或不存在',
    total: '共 {total} 个账号',
    allStatus: '全部状态',
    statusFilter: '筛选账号状态',
    relationFilter: '筛选我的账号关系',
    querySevenDayUsage: '查询七日触达用量',
    sortAscending: '升序排列',
    sortDescending: '降序排列',
    ...
    relations: { all: '全部关系', currentResidence: '当前居住账号', primaryResidence: '首选居住账号', sevenDayContact: '七日触达账号', historicalContact: '历史触达账号' },
    residents: { active: '近 1 小时活跃居民', total: '当前居民', draining: '排空槽位', conversations: '活跃会话', contacted: '七日触达用户' },
