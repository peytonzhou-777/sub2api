export default {
  ...
  accountPool: {
    ...
    sortAscending: '升序排列',
    sortDescending: '降序排列',
    columns: { id: '账号ID', platformType: '账号类型', group: '分组', relation: '我的关系', residents: '居民', capacity: '账号容量', usageWindow: '账号用量', personalUsage: '个人用量', status: '账号状态' },
