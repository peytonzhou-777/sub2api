export default {
  ...
  accountPool: {
    ...
    sortAscending: '升序排列',
    sortDescending: '降序排列',
    columns: { id: '账号ID', platformType: '账号类型', relation: '我的关系', capacity: '账号容量', usageWindow: '账号用量', personalUsage: '个人用量', resetCount: '账号重置次数', status: '账号状态' },
    relations: { all: '全部关系', currentResidence: '当前居住账号', sevenDayContact: '七日触达账号', historicalContact: '历史触达账号' },
