export default {
  common: {
    ...
    total: '总计',
    balance: '余额',
    ordinaryBalance: '普通余额',
    limitedCredit: '限时额度',
    limitedBalance: '限时余额',
    earliestExpiringLimitedBalance: '最先到期限时余额',
    expiresOn: '{date} 到期',
    viewLimitedBalanceDetails: '查看限时余额详情',
    ...
    processing: '处理中...',
    contactSupport: '联系客服',
    customerServiceGroupNumber: '群号：{number}',
    customerServiceGroupAction: '复制群号 {number} 并打开客服群',
    customerServiceGroupCopied: '客服群号已复制',
    add: '添加',
  ...
  auth: {
    ...
    legacyEligibilityCheck: '检测老用户免邀资格',
    legacyEligibilityChecking: '正在检测资格...',
    legacyEligibilityEligible: '该邮箱符合老用户免邀请码注册条件',
    legacyEligibilityNotEligible: '该邮箱不符合老用户免邀请码注册条件',
    legacyEligibilityRequired: '请先检测并通过老用户免邀请码资格，或填写有效邀请码',
    legacyReasonNotLegacyUser: '非原站老用户',
    legacyReasonInsufficientSuccessCalls: '调用次数不足',
    legacyReasonInsufficientActiveDays: '活跃天数不足',
    legacyReasonCyberPolicyWarning: '曾触发过网络安全策略告警',
    legacyReasonSoftDeleted: '原站账号已注销',
    legacyReasonExemptionDisabled: '老用户免邀请码功能未开启',
    registrationCapacityReached: '当前开放名额已用完，请使用有效邀请码注册',
