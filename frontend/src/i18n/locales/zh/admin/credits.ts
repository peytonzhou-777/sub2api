export default {
  credits: {
      ...
      tabs: { users: '用户额度', rechargeActivities: '充值活动', resetRebates: '重置返利' },
      sources: { redeem_code: '兑换码', default_user_setting: '默认设置', recharge_bonus: '充值赠送', admin_manual: '管理员发放', reset_rebate: '重置返利' },
