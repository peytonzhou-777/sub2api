export default {
  credits: {
      ...
      sources: { promo_code: '优惠码兑换', redeem_code: '兑换码', default_user_setting: '默认设置', auth_source_default: '认证来源默认值', affiliate_rebate: '邀请返利', recharge_bonus: '充值赠送', admin_manual: '管理员发放', reset_rebate: '重置返利', recurring_grant: '赠额任务', credit_grant_event: '赠额事件' },
