...
export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '线上默认使用设备+Session：多人共享同一 OAuth 账号时设备标识按账号稳定，Session 按客户端类型/语义协议和槽位收敛，HTTP/WS 共用轮换状态。达到最短寿命且空闲 2 小时后，或达到最长寿命时，新根会话进入新 epoch；已有 Thread 保持旧绑定并自然排空。关闭仅用于回滚，其他模式仅兼容存量配置。',
        codexSessionSlotCount: 'Session 槽位数',
        codexSessionSlotCountDesc: '范围 1–4。线上维护主线建议使用 1，以减少共享可见特征；根会话稳定映射到一个槽位，父代理与子代理共用该槽位。需要更高并发时可显式增加，但会增加上游可见 Session 数。',
        codexSubagentConcurrency: '子代理并发阀门',
        codexSubagentConcurrencyDesc: '限制同一收敛 Session 内同时活动的子代理数，达到上限后有界排队。0 表示关闭；仅会话及完全收敛模式生效。',
        codexFingerprintOff: '关闭（仅回滚）',
        ...
        dynamicPersona: {
          title: '出站 Persona',
          summary: '共 {count} 个 Persona，当前理论并发 {capacity}',
          add: '添加 Persona',
          profile: '出站身份',
          proxy: '出站代理',
          inheritProxy: '继承账号代理',
          maxClients: '活跃客户端 Session 上限',
          inheritPolicy: '继承 Persona 策略',
          primary: '默认 Codex / 账号主授权',
          clients: '客户端占用',
          capacity: '并发容量',
          authorize: '授权',
          reauthorize: '重新授权',
          ...
          hardDisable: '硬停用',
          retire: '退休记录',
          oauthTitle: '授权出站 Persona（位置 {position}）',
          migrationRequired: '该账号尚未建立动态 Persona，需要先完成维护窗口迁移。',
          revokeConfirm: '撤销该 Persona 的全部本地授权链？其他 Persona 不受影响。',
          hardDisableConfirm: '立即硬停用该 Persona？该操作用于安全事件。',
          retireConfirm: '永久退休该 Persona 记录？历史记录仍保留在数据库审计中。',
          forceRotateConfirm: '强制轮转会撤销当前占用，确认继续？'
        },
      ...
      routeDetection: '实际路由检测',
      routeDetectionTitle: 'OpenAI OAuth 实际路由检测',
      routeDetectionRunning: '检测中...',
      routeDetectionRunAgain: '重新检测',
      routeDetectionStatusSol: 'Sol',
      routeDetectionStatusLuna: 'Luna',
      routeDetectionStatusInconclusive: '无法判断',
      routeDetectionStatusError: '检测错误',
      routeDetectionStatusNotChecked: '未检测',
      routeDetectionRequestedModel: '请求模型',
      routeDetectionReportedModel: '响应模型',
      routeDetectionCheckedAt: '检测时间',
      routeDetectionCredentialAccount: '凭据账号 ID',
      routeDetectionReasonCode: '判定原因',
      routeDetectionResponseHeaders: '辅助响应头',
      routeDetectionNotReturned: '未返回',
      routeDetectionRequestFailed: '检测请求失败，请重试。',
      intelligenceTest: '降智检测',
      intelligenceTestTitle: 'OpenAI OAuth 降智检测',
      readyToIntelligenceTest: '准备检测。点击“开始检测”发送固定题目...',
      startIntelligenceTest: '开始检测',
      intelligenceTesting: '降智检测中...',
      intelligenceTestCompleted: '降智检测完成！',
      startingIntelligenceTestForAccount: '开始检测账号：{name}',
      sendingIntelligenceTest: '正在发送固定降智检测题目...',
      intelligenceTestMode: '模式：固定题目检测',
      intelligencePersonaSlotLabel: '出站身份',
      intelligencePersonaSlotStrict: 'Slot 0 · Codex CLI Strict',
      intelligencePersonaSlotOpenCode: 'Slot 1 · OpenCode',
      intelligencePersonaSlotUnavailable: '{slot}（不可用：{state}）',
      intelligencePersonaStatusLoadFailed: '无法读取 Persona v3 slot 状态，请稍后重试。',
      intelligenceTestStatusLabel: '检测标记',
      intelligenceTestStatusUnmarked: '未标记',
      intelligenceTestStatusPassed: '通过',
      intelligenceTestStatusFailed: '失败',
      intelligenceTestMarkPassed: '标记为通过',
      intelligenceTestMarkFailed: '标记为失败',
      intelligenceTestStatusSaveFailed: '保存降智检测标记失败，请重试。',
