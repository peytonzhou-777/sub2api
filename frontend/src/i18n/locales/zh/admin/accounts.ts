...
export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，设备标识按账号稳定；Session 按客户端类型/语义协议和槽位收敛，HTTP/WS 共用轮换状态。达到最短寿命且空闲 2 小时后，或达到最长寿命时，新根会话进入新 epoch，旧会话自然排空。',
        codexSessionSlotCount: 'Session 槽位数',
        codexSessionSlotCountDesc: '范围 1–4。建议使用 2；根会话稳定映射到一个槽位，父代理与子代理共用该槽位。',
