export default {
    ...
    users: {
      ...
      securityDeposit: {
        ...
        adminGrant: '管理员发放',
        risk: '风险档案',
        riskValue: '{multiplier} 倍 · {strikes} 次处罚',
        grant: '永久冻结发放',
        compensation: '误判补偿',
        deduct: '管理员扣除',
        amount: '金额（元）',
        reasonOptional: '原因或备注（可选）',
        reasonPlaceholder: '留空不影响操作',
        submit: '确认操作',
        deductHint: '管理员扣除只能使用管理员发放保证金，发放余额不足时整笔失败，不会触碰用户实付保证金。',
        lots: '保证金批次',
        paidLot: '用户实付批次',
        adminGrantLot: '永久冻结批次',
        lotBalance: '剩余 {remaining} / 原始 {original}',
        revoke: '撤销误发',
        revokeConfirm: '确认撤销该批次剩余 {amount}？已处罚或已扣除部分不会恢复。',
        originalRefund: '原路退款',
        manualReserve: '人工退款预留',
        refundReserved: '已预留 {amount}',
        originalRefundConfirm: '确认将该实付批次剩余 {amount} 原路退回？退款预留会立即影响密钥资格。',
        manualReserveConfirm: '确认预留该实付批次剩余 {amount}？预留后需在外部完成退款并回填凭证。',
        noLots: '暂无保证金批次',
        refunds: '退款记录',
        manualRefund: '人工外部退款',
        fillEvidence: '回填凭证',
        queryRefund: '查询渠道状态',
        refundQuerySucceeded: '退款状态已更新',
        refundQueryFailed: '暂时无法确认退款结果，请稍后重试或人工核验',
        confirmGatewayFailed: '确认渠道未退款并释放',
        refundReviewReleased: '已根据核验凭证释放退款预留',
        externalRefundId: '外部退款单号',
        externalRefundedAt: '外部退款时间',
        externalEvidence: '退款凭证',
        externalEvidencePlaceholder: '凭证编号、文件地址或财务记录引用',
        confirmExternalRefund: '确认已外部退款',
        noRefunds: '暂无退款记录',
        refundOperationSucceeded: '保证金退款操作成功',
        refundOperationFailed: '保证金退款操作失败',
        refundStates: {
          reserved: '已预留',
          submitting: '提交中',
          pending: '网关处理中',
          manual_review: '待人工确认',
          succeeded: '已退款',
          failed_released: '失败并释放',
          canceled: '已取消'
        },
        ledger: '最近流水',
        loadFailed: '保证金详情加载失败',
        operationSucceeded: '保证金操作成功',
        operationFailed: '保证金操作失败',
        unlockKey: '解除网安锁定',
        unlockReasonPlaceholder: '可填写复核结论或申诉编号',
        unlockHint: '解锁后密钥保持禁用，不会自动恢复调用。',
        unlockSucceeded: '密钥安全锁已解除，当前保持禁用',
        unlockFailed: '密钥安全解锁失败'
      },
      // User Attributes
      attributes: {
        title: '用户属性配置',
    ...
    groups: {
      ...
      form: {
        ...
        securityDepositRequired: '保证金门槛（元）',
        securityDepositRequiredHint: '0 表示无需保证金；限时冻结和永久冻结保证金均计入准入余额',
