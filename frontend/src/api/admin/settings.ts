...
import { openAIAccountAdmissionSettingsAPI } from "./openaiAccountAdmissionSettings";
import type {
  CustomEndpoint,
  CustomMenuItem,
...
export * from "./openaiAccountAdmissionSettings";
...
export interface SystemSettings {
  ...
  security_deposit_max_risk_multiplier: number;
  security_deposit_policy_version: string;
  security_deposit_agreement_content_zh: string;
  security_deposit_agreement_content_en: string;
...
export const settingsAPI = {
  ...
  ...openAIAccountAdmissionSettingsAPI,
};
