...
describe("admin settings auth source defaults helpers", () => {
  it("builds auth source defaults state from flat settings fields", () => {
    ...
    expect(state.email).toEqual({
      ...
      limited_credits: [{ amount: 4.5, validity_days: 20 }],
  ...
  it("appends auth source defaults back onto update payload", () => {
    ...
    appendAuthSourceDefaultsToUpdateRequest(payload, {
      email: {
        ...
        limited_credits: [{ amount: 2.5, validity_days: 14 }],
        grant_on_signup: true,
        grant_on_first_bind: false,
        platform_quotas: {},
      },
  ...
  it("appends sanitized nested platform_quotas with non-null values in update payload", () => {
    ...
    appendAuthSourceDefaultsToUpdateRequest(payload, {
      ...
      linuxdo: { balance: 0, concurrency: 5, subscriptions: [], limited_credits: [], grant_on_signup: false, grant_on_first_bind: false, platform_quotas: {} },
      oidc:    { balance: 0, concurrency: 5, subscriptions: [], limited_credits: [], grant_on_signup: false, grant_on_first_bind: false, platform_quotas: {} },
      wechat:  { balance: 0, concurrency: 5, subscriptions: [], limited_credits: [], grant_on_signup: false, grant_on_first_bind: false, platform_quotas: {} },
      github:  { balance: 0, concurrency: 5, subscriptions: [], limited_credits: [], grant_on_signup: false, grant_on_first_bind: false, platform_quotas: {} },
      google:  { balance: 0, concurrency: 5, subscriptions: [], limited_credits: [], grant_on_signup: false, grant_on_first_bind: false, platform_quotas: {} },
      dingtalk: { balance: 0, concurrency: 5, subscriptions: [], limited_credits: [], grant_on_signup: false, grant_on_first_bind: false, platform_quotas: {} },
    });
