...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIOAuthService := service.ProvideOpenAIOAuthService(proxyRepository, openAIOAuthClient, privacyClientFactory, openAIPersonaCredentialRepository, secretEncryptor, geminiTokenCache)
	...
	accountPoolService := service.ProvideAccountPoolService(accountPoolSource, accountPoolSnapshotCache, concurrencyService, usageLogRepository, accountRepository, apiKeyService, settingService, configConfig)
