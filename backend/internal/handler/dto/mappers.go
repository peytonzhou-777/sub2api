...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		GroupID:                    k.GroupID,
		Status:                     k.Status,
		SecurityLockedAt:           k.SecurityLockedAt,
		SecurityLockViolationID:    k.SecurityLockViolationID,
		SecurityLockReason:         k.SecurityLockReason,
		DisabledReason:             k.DisabledReason,
		DisabledFinancialEventType: k.DisabledFinancialEventType,
		DisabledFinancialEventID:   k.DisabledFinancialEventID,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		FirstResponseMs:           l.FirstResponseMs,
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	return &AdminUsageLog{
		UpstreamTurnStateSizeBytes: l.UpstreamTurnStateSizeBytes,
		UsageLog:                   usageLog,
