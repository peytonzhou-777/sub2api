...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		SecurityDepositEnforcementEnabled:                      settings.SecurityDepositEnforcementEnabled,
		SecurityDepositSelfRefundEnabled:                       settings.SecurityDepositSelfRefundEnabled,
		SecurityDepositPenaltyMode:                             settings.SecurityDepositPenaltyMode,
		SecurityDepositFreezeHours:                             settings.SecurityDepositFreezeHours,
		SecurityDepositMaxRiskMultiplier:                       settings.SecurityDepositMaxRiskMultiplier,
		...
		CodexFingerprintMinSessionAgeHours:                     settings.CodexFingerprintMinSessionAgeHours,
		CodexFingerprintMaxSessionAgeHours:                     settings.CodexFingerprintMaxSessionAgeHours,
		CodexFingerprintRotationJitterHours:                    settings.CodexFingerprintRotationJitterHours,
		CodexFingerprintIdleGateMinutes:                        settings.CodexFingerprintIdleGateMinutes,
		CodexFingerprintOldEpochGraceHours:                     settings.CodexFingerprintOldEpochGraceHours,
