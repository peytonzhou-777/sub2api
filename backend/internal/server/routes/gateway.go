...
func RegisterGatewayRoutes(
	...
	gemini.Use(middleware.APIKeyAuthWithSubscriptionGoogleAndBillingCache(apiKeyService, subscriptionService, billingCacheService, cfg))
	...
	antigravityV1Beta.Use(middleware.APIKeyAuthWithSubscriptionGoogleAndBillingCache(apiKeyService, subscriptionService, billingCacheService, cfg))
