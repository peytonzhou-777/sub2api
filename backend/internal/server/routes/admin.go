...
func registerRecurringCreditRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	tasks := admin.Group("/credits/recurring-grants")
	{
		...
		tasks.POST("/:id/batches/:batch_id/reissue/preview", h.Admin.RecurringCredit.PreviewReissue)
		tasks.POST("/:id/batches/:batch_id/reissue", h.Admin.RecurringCredit.Reissue)
...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.GET("/account-request-stats", h.Admin.Ops.GetAccountRequestWindowStats)
...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	{
		credits.GET("/grant-events", h.Admin.User.ListCreditGrantEvents)
		credits.POST("/grant-events", h.Admin.User.CreateCreditGrantEvent)
		credits.PUT("/grant-events/:event_id", h.Admin.User.UpdateCreditGrantEvent)
		credits.DELETE("/grant-events/:event_id", h.Admin.User.DeleteCreditGrantEvent)
		credits.GET("/users", h.Admin.User.ListCreditUsers)
		credits.GET("/users/:id", h.Admin.User.GetCreditUserDetail)
		credits.POST("/users/:id/grant-events/:event_id/trigger", h.Admin.User.TriggerCreditGrantEvent)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/codex-fingerprint", h.Admin.Account.GetCodexFingerprintStatus)
		accounts.POST("/:id/codex-fingerprint/rotate", h.Admin.Account.RotateCodexFingerprint)
		accounts.POST("/:id/codex-fingerprint/disable", h.Admin.Account.DisableCodexFingerprint)
...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.GET("/accounts/:id/persona-oauth", h.Admin.OpenAIOAuth.GetPersonaOAuthStatus)
		...
		openai.DELETE("/accounts/:id/personas/:persona_id", h.Admin.OpenAIOAuth.DeleteAccountPersona)
		openai.POST("/accounts/:id/personas/:persona_id/oauth/generate-auth-url", h.Admin.OpenAIOAuth.GenerateAccountPersonaAuthURL)
		...
		openai.DELETE("/accounts/:id/persona-slots/:slot_id/oauth", h.Admin.OpenAIOAuth.RevokePersonaAuthorization)
