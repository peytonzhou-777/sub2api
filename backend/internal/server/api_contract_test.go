		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySecurityDepositPolicyVersion:      "contract-v1",
					service.SettingKeySecurityDepositAgreementContentZH: "zh policy",
					service.SettingKeySecurityDepositAgreementContentEN: "en policy",
					service.SettingKeySecurityDepositFreezeHours:        "24",
					service.SettingKeySecurityDepositMaxRiskMultiplier:  "8",
					service.SettingKeySecurityDepositEnforcementEnabled: "false",
					service.SettingKeySecurityDepositSelfRefundEnabled:  "false",
					service.SettingKeySecurityDepositPenaltyMode:        "off",
					...
					service.SettingKeyDefaultSecurityDeposit: "100.25",
			...
			wantJSON: `{
				...
				"data": {
					...
					"auth_source_default_email_limited_credits": [],
					...
					"auth_source_default_github_limited_credits": [],
					...
					"auth_source_default_google_limited_credits": [],
					...
					"auth_source_default_linuxdo_limited_credits": [],
					...
					"auth_source_default_oidc_limited_credits": [],
					...
					"auth_source_default_wechat_limited_credits": [],
					...
					"table_default_page_size": 20,
						...
						"user_spending_ranking_thresholds": [20, 50, 100, 200],
					...
					"security_deposit_policy_version": "contract-v1",
					"security_deposit_agreement_content_zh": "zh policy",
					"security_deposit_agreement_content_en": "en policy",
