...
func (s *emailBindDefaultLimitedCreditGranterStub) GrantFromAuthSourceSettings(
	context.Context,
	int64,
	string,
	[]service.DefaultLimitedCreditSetting,
...
func TestAuthServiceBindEmailIdentity_UpdatesEmailAndAppliesFirstBindDefaults(t *testing.T) {
	...
	svc, _, client := newAuthServiceForEmailBind(t, map[string]string{
		...
		service.SettingKeyAuthSourceLimitedCredits("email"):      `[{"amount":9.5,"validity_days":15}]`,
	...
	require.Equal(t, 1, limitedCreditGranter.calls)
