...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	sessionScopeHash := nullString(log.SessionScopeHash)
	sessionSourceHash := nullString(log.SessionSourceHash)
	promptCacheKeyHash := nullString(log.PromptCacheKeyHash)
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			sessionScopeHash,     // session_scope_hash
