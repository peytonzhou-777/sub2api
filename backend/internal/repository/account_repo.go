...
func accountEntityToService(m *dbent.Account) *service.Account {
	...
	return &service.Account{
		...
		CodexFingerprintSeed:           derefString(m.CodexFingerprintSeed),
		CodexFingerprintVersion:        m.CodexFingerprintVersion,
		CodexFingerprintEpoch:          m.CodexFingerprintEpoch,
		CodexFingerprintEpochStartedAt: m.CodexFingerprintEpochStartedAt,
		ProxyID:                        m.ProxyID,
