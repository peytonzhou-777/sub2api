...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "codex_fingerprint_seed", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "codex_fingerprint_version", Type: field.TypeString, Size: 16, Default: ""},
		{Name: "codex_fingerprint_epoch", Type: field.TypeInt64, Default: 0},
		{Name: "codex_fingerprint_epoch_started_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "intelligence_test_status", Type: field.TypeString, Size: 16, Default: ""},
	...
	PromoCodesColumns = []*schema.Column{
		...
		{Name: "reward_type", Type: field.TypeString, Size: 32, Default: "balance"},
	...
	PromoCodeUsagesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{PromoCodeUsagesColumns[6]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{PromoCodeUsagesColumns[5], PromoCodeUsagesColumns[6]},
			},
		},
	}
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "upstream_turn_state_size_bytes", Type: field.TypeInt, Nullable: true, SchemaType: map[string]string{"postgres": "integer"}},
		{Name: "billing_type", Type: field.TypeInt8, Default: 0},
		{Name: "stream", Type: field.TypeBool, Default: false},
		{Name: "duration_ms", Type: field.TypeInt, Nullable: true},
		{Name: "first_token_ms", Type: field.TypeInt, Nullable: true},
		{Name: "first_response_ms", Type: field.TypeInt, Nullable: true},
		{Name: "first_event_ms", Type: field.TypeInt, Nullable: true},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[49], UsageLogsColumns[47], UsageLogsColumns[51]},
			},
			{
