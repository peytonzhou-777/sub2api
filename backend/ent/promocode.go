...
func (*PromoCode) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case promocode.FieldID, promocode.FieldValidityDays, promocode.FieldMaxUses, promocode.FieldUsedCount:
			values[i] = new(sql.NullInt64)
		case promocode.FieldCode, promocode.FieldRewardType, promocode.FieldStatus, promocode.FieldNotes:
