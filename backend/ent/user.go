...
type UserEdges struct {
	...
	// LimitedCreditGrants holds the value of the limited_credit_grants edge.
	LimitedCreditGrants []*UserLimitedCreditGrant `json:"limited_credit_grants,omitempty"`
	// LimitedCreditLedgerEntries holds the value of the limited_credit_ledger_entries edge.
	LimitedCreditLedgerEntries []*UserLimitedCreditLedger `json:"limited_credit_ledger_entries,omitempty"`
...
// LimitedCreditGrantsOrErr returns the LimitedCreditGrants value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) LimitedCreditGrantsOrErr() ([]*UserLimitedCreditGrant, error) {
	if e.loadedTypes[13] {
		return e.LimitedCreditGrants, nil
	}
	return nil, &NotLoadedError{edge: "limited_credit_grants"}
}

// LimitedCreditLedgerEntriesOrErr returns the LimitedCreditLedgerEntries value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) LimitedCreditLedgerEntriesOrErr() ([]*UserLimitedCreditLedger, error) {
	if e.loadedTypes[14] {
		return e.LimitedCreditLedgerEntries, nil
	}
	return nil, &NotLoadedError{edge: "limited_credit_ledger_entries"}
}
...
// QueryLimitedCreditGrants queries the "limited_credit_grants" edge of the User entity.
func (_m *User) QueryLimitedCreditGrants() *UserLimitedCreditGrantQuery {
	return NewUserClient(_m.config).QueryLimitedCreditGrants(_m)
}

// QueryLimitedCreditLedgerEntries queries the "limited_credit_ledger_entries" edge of the User entity.
func (_m *User) QueryLimitedCreditLedgerEntries() *UserLimitedCreditLedgerQuery {
	return NewUserClient(_m.config).QueryLimitedCreditLedgerEntries(_m)
}
